...
public class SendEmail {
    ...
    public static void send(List<String> emailList) {
        ...
        for (String email : emailList) {
            ...
            String from = "romulus.chitic@gmail.com";
            ...
            try {
                ...
                message.setSubject("Hai sa vedem daca merge");

//                // Now set the actual message
//                message.setText("Asta este continutul mesajului");
